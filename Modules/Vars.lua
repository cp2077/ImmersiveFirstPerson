return {
    ...
    FREELOOK = {
        ...
        MAX_LATERAL_OFFSET = 0.200,
        COMBAT_MAX_LATERAL_OFFSET = 0.080,
        MAX_BACK_OFFSET = 0.020,
        DOWNWARD_LATERAL_REDUCTION = 0.25,
        SHOULDER_BACK_OFFSET = 0.012,
        SHOULDER_BACK_START_YAW_PROGRESS = 0.30,
        SHOULDER_BACK_FULL_YAW_PROGRESS = 0.75,
        SIDE_FORWARD_HOLD_START_PITCH = -50.0,
        SIDE_FORWARD_HOLD_FULL_PITCH = 0.0,
        SIDE_RISE_BACK_OFFSET = 0.020,
        SIDE_CORRECTION_FULL_YAW_PROGRESS = 0.65,
        SIDE_NATIVE_MOTION_REDUCTION = 0.65,
        BACK_NATIVE_MOTION_REDUCTION = 1.0,
        SIDE_PITCH_NORMALIZATION = 0.06,
        MAX_SIDE_PITCH_NORMALIZATION = 5.0,
        SIDE_UPWARD_BIAS = 2.0,
        SIDE_UPWARD_BIAS_FADE_PITCH = 30.0,
        SIDE_UPWARD_MOTION_REDUCTION = 1.0,
        SIDE_UPWARD_MOTION_RANGE = 50.0,
        MAX_ROLL = 14.0,
        COMBAT_MAX_ROLL = 0.0,
